...
namespace DoubleDoubleGeometry.Geometry2D {
    ...
    public class Ellipse2D : IGeometry<Ellipse2D, Vector2D>, IFormattable {
        ...
        public Ellipse2D(Vector2D center, (ddouble major, ddouble minor) axis, ddouble rotation) {
            this.Center = center;
            this.Axis = axis;
        ...
        public static Ellipse2D FromImplicit(ddouble a, ddouble b, ddouble c, ddouble d, ddouble e, ddouble f) {
            ...
            return new Ellipse2D((cx, cy), (major_axis, minor_axis), rotation * ddouble.Pi);
        }
...
#pragma warning restore CS8632
        ...
        public Matrix2D Matrix {
            get {
                ...
                ddouble c = ddouble.Cos(Rotation), s = ddouble.Sin(Rotation);
        ...
        public static Ellipse2D operator +(Ellipse2D g, Vector2D v) {
            return new(g.Center + v, g.Axis, g.Rotation);
        }
        ...
        public static Ellipse2D operator -(Vector2D v, Ellipse2D g) {
            return new(v - g.Center, g.Axis, g.Rotation);
        }

        public static Ellipse2D operator *(Complex c, Ellipse2D g) {
            ddouble norm = c.Norm;

            return new(g.Center * norm, (g.Axis.major * norm, g.Axis.minor * norm), g.Rotation + c.Phase);
        }

        public static Ellipse2D operator *(Ellipse2D g, ddouble r) {
            return new(g.Center * r, (g.Axis.major * ddouble.Abs(r), g.Axis.minor * ddouble.Abs(r)), g.Rotation);
        }

        public static Ellipse2D operator *(Ellipse2D g, double r) {
            return new(g.Center * r, (g.Axis.major * double.Abs(r), g.Axis.minor * double.Abs(r)), g.Rotation);
        }
        ...
        public static implicit operator Ellipse2D((Vector2D center, (ddouble major, ddouble minor) axis, ddouble rotation) g) {
            return new(g.center, g.axis, g.rotation);
        }

        public static implicit operator (Vector2D center, (ddouble major, ddouble minor) axis, ddouble rotation)(Ellipse2D g) {
            return (g.Center, g.Axis, g.Rotation);
        }

        public void Deconstruct(out Vector2D center, out (ddouble major, ddouble minor) axis, out ddouble rotation)
        ...
        public static bool IsNaN(Ellipse2D g) {
            return Vector2D.IsNaN(g.Center) || ddouble.IsNaN(g.Axis.major) || ddouble.IsNaN(g.Axis.minor) || ddouble.IsNaN(g.Rotation);
        }
        ...
        public static bool IsFinite(Ellipse2D g) {
            return Vector2D.IsFinite(g.Center) && ddouble.IsFinite(g.Axis.major) && ddouble.IsFinite(g.Axis.minor) && ddouble.IsFinite(g.Rotation);
        }
        ...
        public string ToString([AllowNull] string format, [AllowNull] IFormatProvider formatProvider) {
            ...
            return $"center={Center.ToString(format)}, axis=({Axis.major.ToString(format)}, {Axis.minor.ToString(format)}), rotation={Rotation.ToString(format)}";
        }
        ...
        public override int GetHashCode() {
            return Center.GetHashCode() ^ Axis.major.GetHashCode() ^ Axis.minor.GetHashCode() ^ Rotation.GetHashCode();
        }
    }
}
