...
namespace DoubleDoubleGeometry.Geometry3D {
    ...
    public class Ellipse3D : IGeometry<Ellipse3D, Vector3D>, IFormattable {
        ...
        private Ellipse3D(Vector3D center, Vector3D normal, (ddouble major, ddouble minor) axis, ddouble angle, int _) {
            this.Center = center;
            this.Normal = normal;
            this.Axis = axis;
...
#pragma warning restore CS8632
        ...
        public static Ellipse3D operator -(Ellipse3D g) {
            return new(-g.Center, -g.Normal, g.Axis, g.Angle, 0);
        }

        public static Ellipse3D operator +(Ellipse3D g, Vector3D v) {
            return new(g.Center + v, g.Normal, g.Axis, g.Angle, 0);
        }
        ...
        public static Ellipse3D operator -(Vector3D v, Ellipse3D g) {
            return new(v - g.Center, -g.Normal, g.Axis, g.Angle, 0);
        }

        public static Ellipse3D operator *(Quaternion q, Ellipse3D g) {
            ddouble norm = q.Norm;

            return new(g.Center * norm, (q / norm) * g.Normal, (g.Axis.major * norm, g.Axis.minor * norm), g.Angle);
        }
        ...
        public static bool IsNaN(Ellipse3D g) {
            return Vector3D.IsNaN(g.Center) || Vector3D.IsNaN(g.Normal) || ddouble.IsNaN(g.Axis.major) || ddouble.IsNaN(g.Axis.minor) || ddouble.IsNaN(g.Angle);
        }

        public static bool IsZero(Ellipse3D g) {
            return Vector3D.IsZero(g.Center) && Vector3D.IsZero(g.Normal) && ddouble.IsZero(g.Axis.major) && ddouble.IsZero(g.Axis.minor) && ddouble.IsZero(g.Angle);
        }

        public static bool IsFinite(Ellipse3D g) {
            return Vector3D.IsFinite(g.Center) && Vector3D.IsFinite(g.Normal) && ddouble.IsFinite(g.Axis.major) && ddouble.IsFinite(g.Axis.minor) && ddouble.IsFinite(g.Angle);
        }
        ...
        public override string ToString() {
            return $"center={Center}, normal={Normal}, axis={Axis}, angle={Angle}";
        }
        ...
        public string ToString([AllowNull] string format, [AllowNull] IFormatProvider formatProvider) {
            ...
            return $"center={Center.ToString(format)}, normal={Normal.ToString(format)}, axis=({Axis.major.ToString(format)}, {Axis.minor.ToString(format)}), angle={Angle.ToString(format)}";
        }
        ...
        public override bool Equals(object obj) {
            return (obj is not null) && obj is Ellipse3D geo && geo == this;
        }
        ...
        public override int GetHashCode() {
            return Center.GetHashCode() ^ Normal.GetHashCode() ^ Axis.major.GetHashCode() ^ Axis.minor.GetHashCode() ^ Angle.GetHashCode();
        }
    }
}
